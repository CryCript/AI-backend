...
@InputType()
class WeddingInvitationCreateNestedManyWithoutUsersInput {
...
export { WeddingInvitationCreateNestedManyWithoutUsersInput as WeddingInvitationCreateNestedManyWithoutUsersInput };
