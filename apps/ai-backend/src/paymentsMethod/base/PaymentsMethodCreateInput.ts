...
@InputType()
class PaymentsMethodCreateInput {
  @ApiProperty({
    required: false,
  ...
  @ApiProperty({
    required: false,
    type: () => PaymentCreateNestedManyWithoutPaymentsMethodsInput,
  })
  @ValidateNested()
  @Type(() => PaymentCreateNestedManyWithoutPaymentsMethodsInput)
  @IsOptional()
  @Field(() => PaymentCreateNestedManyWithoutPaymentsMethodsInput, {
    nullable: true,
  })
...
export { PaymentsMethodCreateInput as PaymentsMethodCreateInput };
