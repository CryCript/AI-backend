...
@InputType()
class WeddingInvitationShareCreateNestedManyWithoutWeddingInvitationsInput {
...
export { WeddingInvitationShareCreateNestedManyWithoutWeddingInvitationsInput as WeddingInvitationShareCreateNestedManyWithoutWeddingInvitationsInput };
